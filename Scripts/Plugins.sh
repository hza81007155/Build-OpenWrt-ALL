...
# Argone theme
git clone -b https://github.com/hza81007155/luci-theme-argon.git luci-theme-argon
git clone -b https://github.com/hza81007155/luci-app-argon-config.git luci-app-argon-config
